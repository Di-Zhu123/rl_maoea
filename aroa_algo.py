...
from aroa_mating import AROAMating
from pymoo.core.population import Population
from pymoo.core.repair import NoRepair


class AROAAlgorithm(Algorithm):
    ...
    def _infill(self):
        self.mating.mating_load_action(self.action, self.t, self.maxEvals)
    ...
    def algo_load_action(self, action, t, maxEvals):
        self.action = action
        self.t = t
